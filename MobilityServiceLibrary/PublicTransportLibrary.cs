...
namespace MobilityServiceLibrary
{
    ...
    public class PublicTransportLibrary
    {
        ...
        public async Task<List<Route>> GetRoutes(AgencyType agency)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetRoutesUri(agency));
        ...
        public async Task<List<Stop>> GetStops(AgencyType agency, string routeId)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetStopsUri(agency, routeId));
        ...
        public async Task<List<StopTime>> GetTimetable(AgencyType agency, string routeId, string stopId)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetTimetableUri(agency, routeId, stopId));
        ...
        public async Task<List<TripData>> GetLimitedTimetable(AgencyType agency, string stopId, int numberOfResult)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetLimitedTimetableUri(agency, stopId, numberOfResult));
        ...
        public async Task<TimeTable> GetTransitTimes(string routeId, int timeFrom, int timeTo)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetTransitTimesUri(routeId, timeFrom, timeTo));
        ...
        public async Task<TimeTable> GetTransitDelays(string routeId, int timeFrom, int timeTo)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetTransitDelaysUri(routeId, timeFrom, timeTo));
        ...
        public async Task<List<Parking>> GetParkingsByAgency(AgencyType agency)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetParkingsByAgencyUri(agency));
        ...
        public async Task<List<AlertRoad>> GetRoadInfoByAgency(AgencyType agency, int timeFrom, int timeTo)
        {
            ...
            string JSONResult = await webCli.DownloadStringTaskAsync(PublicTransportUriHelper.GetRoadInfoByAgencyUri(agency, timeFrom, timeTo));
